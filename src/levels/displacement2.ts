...
//
// Numbers come from `legacy/src/levels/displacement2.mxml`.
//
...
export const displacement2: LevelBuilder = (difficulty): LevelConfig => {
  ...
  if (difficulty === 3) {
    ...
    // Vertical spike at x=230, oscillating y=110..260 at speed 7 — sits
    // in the gap below the middle cloud, guarding the upward route.
    spikes.push({
      x: 230,
      y: 260,
      isMoving: true,
